...
public class MainActivityTH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_th);
            ...
            case jsoncode:
                ...
                if (isSuccess(response)) {
                    ...
                    try {
                        ...
                        congThuc = dataObj.getString("ingredient");
                    ...
                    Toast.makeText(MainActivityTH.this, getErrorCode(response), Toast.LENGTH_SHORT).show();
                }
        }

        tvTH = (TextView) findViewById(R.id.tvTH);
        tvTH.setText(congThuc);
